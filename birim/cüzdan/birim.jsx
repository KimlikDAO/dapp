...
const Cüzdan = (değerler) => {
  const { DefaultChain, Chains } = değerler;
  const resimSrc = resimAdı(DefaultChain);

  return (
    <div id="cu">
      <link rel="stylesheet" href="/birim/cüzdan/birim.css" data-shared />
      <button id="cuc"><img src={resimSrc} height="32" width="32" /></button>
        ...
        <ul id="cue" style="display:none">
          <div id="cueh">
            ...
            <div>
              ...
              <span id="cude">DeBank</span> <span id="cuex">Explorer</span>
