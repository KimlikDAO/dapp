  ...
  return (
    <div id={Css.Welcome}>
      <h2>{{ en: "Welcome, here’s your KPass 👋", tr: "Hoşgeldiniz, işte KPass’iniz 👋" }}</h2>{{
        en: <p>You can click on the regenerate button to customize its appearance. For now,
          it contains no data and it’s not written on chain. Let’s add some data into it.</p>,
        tr: <p>Görünümünü özelleştirmek için yeniden oluştur düğmesini kullanabilirsiniz.
          Şu anda içinde veri yok ve zincire yazılmamış. Haydi içine bazı veriler ekleyelim.</p>
      }}
      <Button
