 ...
 */
 ...
 const aktifOyKartıOluştur = (data, votes) => {
   ...
   birazBekle().then(() => {
     ...
     var toplamOylar = votes.yes + votes.no + votes.abstain;
     var evetYüzdesi = yüzdele(votes.yes, toplamOylar)
     var hayırYüzdesi = yüzdele(votes.no, toplamOylar)
     var çekimserYüzdesi = yüzdele(votes.abstain, toplamOylar)
     console.log(evetYüzdesi, hayırYüzdesi, çekimserYüzdesi);
   })
 ...
 const yeniOy = aktifOyKartıOluştur(data, dummyOySayısı);
 const yeniOy1 = aktifOyKartıOluştur(data1, dummyOySayısı1);
